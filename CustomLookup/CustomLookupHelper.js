({
    ...
    getParams: function(component, event, helper) {
        ...
        var isFilterRecordId = component.get('v.filterByParentId');
        var filterObjectName = component.get('v.filterObjectName');
        ...
        return {
            ...
            isFilterRecordId : isFilterRecordId,
    ...
    addNewRecordJS_Helper : function(component, event, helper) {
        var searchData = component.get("v.lastSearchTerm");
        var cmpEvent = component.getEvent("cmpEvent");
        cmpEvent.setParams({"getMessage" : searchData});
        cmpEvent.fire();
    },
})